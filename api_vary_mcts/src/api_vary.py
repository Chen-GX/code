...
toolqa_params = {
    ...
    2: {
        ...
        "FilterDB": {  # 特判
            "filterCriteria": "condition",  # {"filterCriteria1": , "filterCriteria2": }
        },
        "GetValue": {
        ...
        "SQLInterpreter": {
            "SQLQuery": "SQL",  # "This is my SQLQuery: "
        },
        "PythonInterpreter": {
            "pythonCode": "Python",  # "Excuse the following Python code: "
        },
        "Finish": {
            "answer": "answer",
        },

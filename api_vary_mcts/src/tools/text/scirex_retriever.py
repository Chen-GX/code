...
EMBED_MODEL_NAME = "/yinxr/workhome/zzhong/chenguoxin/model_cache/all-mpnet-base-v2"
CHROMA_PERSIST_DIRECTORY = "/yinxr/workhome/zzhong/chenguoxin/datasets/ToolQA/data/chroma_db/scirex-v2"
CHROMA_COLLECTION_NAME = "all"
CHROMA_SERVER_HOST = ""
CHROMA_SERVER_HTTP_PORT = ""
FILE_PATH = "/yinxr/workhome/zzhong/chenguoxin/datasets/ToolQA/data/external_corpus/scirex/Preprocessed_Scirex.jsonl"
...
def insert_to_db(texts, model, cuda_idx, db):
